---
title: "Creating a TI method: Bare-bones"
date: "`r Sys.Date()`"
author:
- Wouter Saelens
- Robrecht Cannoodt
...
vignette: >
  %\VignetteIndexEntry{Creating a TI method: Bare-bones}
...
run_fun <- function(expression, priors, params, seed, verbose) {
...
model <- infer_trajectory(dataset, method, verbose = 3)
```
...
<!-- The main function can accept any additional parameters, which should also be defined in a parameter set This allows you to specify the type of parameter (integer, numeric, character, logical, ...), the possible range of values and the default value. Check out `?dynparam` for more information on the possible options. -->
...
<!--     default = 1L, -->
<!--     distribution = dynparam::uniform_distribution(lower = 1L, upper = 10L) -->
<!--   ) -->
<!-- ) -->
<!-- ``` -->
