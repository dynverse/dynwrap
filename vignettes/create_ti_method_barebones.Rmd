...
To create the method, call `create_ti_method_r`. At this stage you can also define some R packages that have to be installed or loaded.
```{r}
...
if ("dynplot" %in% rownames(installed.packages())) {
  dynplot::plot_dimred(model, color_cells = "pseudotime" , expression_source = as.matrix(dataset$expression))
}
```
