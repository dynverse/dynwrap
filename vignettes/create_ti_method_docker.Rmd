...
- **output_ids** The kinds of output this wrapper produces. This always include at least one output which contains enough information to produce a trajectory.
...
output_example_urls <- function(output_ids) {
  if (length(output_ids) > 0) {
    map(output_ids, output_example_url) %>% glue::collapse(", ")
  } else {
    ""
  }
}
