...
An example of a `definition.yml` file (as can be found on the [github](https://github.com/dynverse/dynwrap_tester/blob/devel/R_feather/definition.yml)):

```{r, echo=FALSE, results="asis"}
read_file("https://raw.githubusercontent.com/dynverse/dynwrap_tester/devel/R_feather/definition.yml") %>%
  paste0("```yaml\n", ., "\n```") %>% 
  cat()
```
...
An example of a `Dockerfile` (as can be found on the [github](https://github.com/dynverse/dynwrap_tester/blob/devel/R_feather/Dockerfile)):

```{r, echo=FALSE, results="asis"}
read_file("https://raw.githubusercontent.com/dynverse/dynwrap_tester/devel/R_feather/Dockerfile") %>%
  paste0("```Dockerfile\n", ., "\n```") %>% 
  cat()
```
