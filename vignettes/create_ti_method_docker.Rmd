...
read_file("https://raw.githubusercontent.com/dynverse/comp1/devel/definition.yml") %>%
  paste0("```yaml\n", ., "\n```") %>% 
  cat()
```
...
dynwrap:::output_processors %>% 
  ...
  mutate(
    creates_trajectory = ifelse(creates_trajectory, "✔", ""),
...
```{r, echo=FALSE, results="asis"}
read_file("https://raw.githubusercontent.com/dynverse/comp1/devel/Dockerfile") %>%
  paste0("```Dockerfile\n", ., "\n```") %>% 
  cat()
```
...
```{r, echo=FALSE, results="asis"}
read_file("https://raw.githubusercontent.com/dynverse/comp1/devel/run.R") %>%
  paste0("```r\n", ., "\n```") %>% 
  cat()
```
