...
```r
infer_trajectory(task, ti_comp1, list(debug = TRUE))
```
...
This will print a shell command which can be used to enter the container with the /input and /output directories mounted.
