context("Testing add_linear_trajectory_to_wrapper")
...
test_that("Testing add_linear_trajectory_to_wrapper", {
  wr <-
    wr_orig %>%
...
test_that("Testing add_linear_trajectory_to_wrapper fails when expected", {
  expect_error(
    wr_orig %>%
    add_linear_trajectory_to_wrapper(
