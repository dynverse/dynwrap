context("Testing add_grouping_to_wrapper")
...
test_that("Testing add_grouping_to_wrapper", {
  wr <- wr_orig %>%
...
test_that("Testing add_grouping_to_wrapper with a subset of cells", {
  wr <- wr_orig %>%
    add_grouping_to_wrapper(
      group_ids = group_ids,
...
test_that("Testing add_grouping_to_wrapper fails when groupings is not in the correct format", {
  expect_error(
    wr_orig %>%
      add_grouping_to_wrapper(
        group_ids = group_ids,
