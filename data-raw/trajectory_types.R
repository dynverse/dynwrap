...
trajectory_types <- tribble(
  ...
  # binary trees
  "unrooted_binary_tree",           "binary_tree",               "#00b009", FALSE,
  "rooted_binary_tree",             "binary_tree",               "#00b009", TRUE,
  ...
  # disconnected
  "disconnected_undirected_graph",  "disconnected_graph",   "#ca0565", FALSE,
  "disconnected_directed_graph",    "disconnected_graph",   "#ca0565", TRUE,
